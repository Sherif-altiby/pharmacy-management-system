...
const Navbar = () => {
  return (
    <nav className="h-16 flex items-center border-b px-4">
       <div className="container mx-auto flex justify-between items-center">
            <div className="w-8 h-8 rounded-full border flex justify-center items-center cursor-pointer" > <FaBars /> </div>
